...
public final class gradeList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t        url:\"GradeServlet?method=GradeList&course=course&t=\"+new Date().getTime(),\n");
      ...
      out.write("            } else{\n");
      out.write("            \tvar gradeid = selectRow.id;\n");
      out.write("            \t$.messager.confirm(\"消息提醒\", \"将删除与年级相关的所有数据(包括班级,学生)，确认继续？\", function(r){\n");
      out.write("            \t\tif(r){\n");
      out.write("            \t\t\t$.ajax({\n");
      out.write("\t\t\t\t\t\t\ttype: \"post\",\n");
      out.write("\t\t\t\t\t\t\turl: \"GradeServlet?method=DeleteGrade\",\n");
      out.write("\t\t\t\t\t\t\tdata: {gradeid: gradeid},\n");
      ...
      out.write("\t\t\t\t\t\t\t$.ajax({\n");
      out.write("\t\t\t\t\t\t\t\ttype: \"post\",\n");
      out.write("\t\t\t\t\t\t\t\turl: \"GradeServlet?method=AddGrade\",\n");
      ...
      out.write("\t    \t\t\t<td><select id=\"add_courseList\" style=\"width: 200px; height: 30px;\" name=\"clazzid\" data-options=\"required:true, missingMessage:'请选择课程'\" ></select></td>\n");
      out.write("\t    \t\t</tr>\n");
      out.write("\t    \t</table>\n");
      out.write("\t    </form>\n");
      out.write("\t</div>\n");
